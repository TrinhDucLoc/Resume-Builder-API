...
public class PostController {
    ...
    public ResponseEntity<PostDto> createPost(@Valid @RequestBody PostDto postDto, CommentDto commentDto){
        return new ResponseEntity<>(postService.createPost(postDto, commentDto), HttpStatus.CREATED);
    }
    ...
    public ResponseEntity<PostDto> getPostByIdV1(@PathVariable(name = "postId") long id){
